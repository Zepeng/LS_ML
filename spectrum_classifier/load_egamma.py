...
def LoadEGamma(rootfile, evtmax):
    ...
    events = []
    for evtid in range(min(evtmax, len(wave_sum))):
...
def test():
    events = LoadEGamma('/hpcfs/juno/junogpu/luoxj/Data_PSD/elecsim_Electron_001_SumAllPmtWaves.root', 100)
    print(events)
